...
def recalcular_apu(apu):
    ...
    for d in apu.detalles:
        d.subtotal = (d.cantidad or 0) * (d.precio_unitario or 0)
    ...
    apu.costo_materiales = costo_materiales
    apu.costo_mano_obra = costo_mano_obra
    apu.costo_maquinaria = costo_maquinaria

    costo_directo = costo_materiales + costo_mano_obra + costo_maquinaria
    ...
    apu.precio_unitario = costo_directo * (1 + factor)
