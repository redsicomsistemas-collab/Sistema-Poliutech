...
class DemoEnvironment(db.Model):
    ...
    whatsapp_numbers = db.Column(db.Text)
...
class OrdenCompra(db.Model):
    ...
    forma_pago = db.Column(db.String(20), default="CONTADO", nullable=False)
    estatus = db.Column(db.String(30), default="BORRADOR", nullable=False, index=True)
    subtotal = db.Column(db.Float, default=0.0, nullable=False)
    descuento_total = db.Column(db.Float, default=0.0, nullable=False)
    ...
    factura_monto = db.Column(db.Float, default=0.0, nullable=False)
    factura_archivo = db.Column(db.String(260))
    pago_referencia = db.Column(db.String(120))
    pago_monto = db.Column(db.Float, default=0.0, nullable=False)
    pago_archivo = db.Column(db.String(260))
...
class ContabilidadRegistro(db.Model):
    ...
    descripcion = db.Column(db.Text)
    folio_factura = db.Column(db.String(120), index=True)
    monto_total = db.Column(db.Float, default=0.0, nullable=False)
    moneda = db.Column(db.String(10), default="MXN", nullable=False)
    fecha_inicio = db.Column(db.Date, nullable=False, index=True)
    tiempo_credito_dias = db.Column(db.Integer)
